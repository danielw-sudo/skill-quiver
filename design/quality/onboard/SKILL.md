...
context-file: .impeccable.md
---

## Before You Start
Check `.impeccable.md` in the project root for design context. If it exists, use it. If not, proceed with best judgment from the codebase — do not block on setup.

Additionally gather: the "aha moment" you want users to reach, and users' experience level.
