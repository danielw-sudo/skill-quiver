...
3. **Run teach-impeccable (recommended)**: If neither source has context, running teach-impeccable produces best results. If skipped, infer context from the codebase and proceed — do not block on setup.
