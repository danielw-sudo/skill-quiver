...
model: any
description: >-
  Cloud infrastructure and CI/CD pipeline security practices, including IAM configurations, secrets management, VPC security, logging, WAF, and disaster recovery.
