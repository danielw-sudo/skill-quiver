...
model: any
description: >-
  Translate articles and documents between languages with quick, normal, or refined translation workflows. TRIGGER when: user asks to translate, proofread, or localize a document or URL.
...
Schema: [reference/config/extend-schema.md](reference/config/extend-schema.md)
...
Full reference: [reference/config/first-time-setup.md](reference/config/first-time-setup.md)
...
- EN→ZH: [reference/glossary-en-zh.md](reference/glossary-en-zh.md)
...
Full details: [reference/workflow-mechanics.md](reference/workflow-mechanics.md)
...
4. **Assemble translation prompt**:
   - Main agent reads `01-analysis.md` (if exists) and assembles shared context using Part 1 of [reference/subagent-prompt-template.md](reference/subagent-prompt-template.md) — inlining: target style, content background, merged glossary, and translation challenges
...
Full workflow for publication quality. See [reference/refined-workflow.md](reference/refined-workflow.md) for detailed guidelines per step.
