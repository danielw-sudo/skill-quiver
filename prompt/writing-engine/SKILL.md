...
model: any
description: >-
  Structured writing assistant engine that explores and refines a perspective through natural, low-AI-signature prose and computer-science analogical framing. TRIGGER when: user asks to write an article, essay, or thoughts about a specific topic.
